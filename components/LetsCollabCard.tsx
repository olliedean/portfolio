...
export default function LetsCollabCard() {
    return (
        <Link href="mailto:dev@ollie.cool" rel="noopener noreferrer" className="col-span-3 cursor-pointer col-span-4 md:col-span-3">
            <Card colSpan={3} rowSpan={1} className="hover:border-white/20 hover:bg-neutral-800 overflow-hidden">
                <div className="p-3 flex flex-row gap-8">
                    ...
                    <button className="text-sm ml-auto bg-white/4 border-white/5 border-2 text-white font-semibold py-1 rounded self-center w-full cursor-pointer">
